# [视图 - 文章](http://zui.sexy/#view/article)

文章视图用于展示带标题和其他额外信息的图文内容.

### css类样式列表
 - [`.article`](#结构): 文章视图的父级容器;
 - [`.article > header`](#结构): 文章视图的头部, 包含文章标题,文章信息和摘要;
 - [`.article > .content`](#结构): 文章视图的正文, 可以在`.article`内堆叠多个正文部分;
 - [`.article > footer`](#结构): 文章视图的底部, 显示版权及文章的其他信息;
 - [`.article > header > h1-h3`](#结构): 文章头部的标题;
 - [`.article > header > dl`](#结构): 文章头部的属性列表;
 - [`.article > header > .abstract`](#结构): 文章头部的摘要信息;
 - [`.article > .content > h1-h6`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > p`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > ul`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > ol`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > dl`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > table`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > img`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > p > img`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > blockquote`](#结构): 文章正文部分支持的元素;
 - [`.article > .content > pre`](#结构): 文章正文部分支持的元素;
 - [`.article-content`](#结构): 同`.article > .content`;
 - [`.article.article-condensed`](#结构): 更紧凑的文章视图;


### 结构

文章视图使用`.article`类作为父级容器, 一般 HTML 结构为:
...
<article class="article">
  ...
  <section class="content">
    ...
    <img src="http://zui.sexy/docs/img/slide1.jpg" alt="">
    <h3>标准化进程</h3>
