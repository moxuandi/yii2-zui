# [视图 - 评论](http://zui.sexy/#view/comment)

评论视图用于展示评论消息, 评论列表允许进行嵌套.

### css类样式列表
 - [`.comments`](#结构): 评论视图的父级容器;
 - [`.comments > header`](#结构): 评论视图的头部, 标题等信息;
 - [`.comments > header > h1-h3`](#结构): 评论视图的头部标题的重要性;
 - [`.comments > .comments-list`](#结构): 评论视图的列表项组, `.comments-list`也可以嵌套放入`.comment`内;
 - [`.comments > .comments-list > .comment`](#评论条目): 评论条目;
 - [`.comments > footer`](#结构): 评论视图的底部, 显示评论表达及分页信息等;
 - [`.comments > footer > .reply-form`](#评论表单): 评论表单;
 - [`.comments > footer > .reply-form > .avatar`](#评论表单): 评论表单的用户头像;
 - [`.comments > footer > .reply-form > .avatar + .form`](#评论表单): 评论表单;
 - [`.comment > .avatar`](#评论条目): 可选, 用于包含一张图片作为发表评论的用户头像;
 - [`.comment > .content`](#评论条目): 用于包含评论内容的容器;
 - [`.comment > .content > .text`](#评论条目): 用于包裹评论正文内容的容器, 作为`.content`的直接子元素;
 - [`.comment > .content > .actions`](#评论条目): 用于包裹评论操作按钮或链接, 作为`.content`的直接子元素;
 - [`.comment > .comments-list`](#嵌套评论列表): 为该条评论嵌套一个新的评论列表, 一般用于显示用户回复的评论条目;


### 结构

评论视图使用`.comments`作为父级容器, 一般 HTML 结构如下:
...
限制嵌套层次: 虽然你可以无限的嵌套评论列表, 但受限于视窗大小和便于用户阅读, 不应该使用超过 3 个层级的嵌套.
...
<div class="comment">
  ...
  <div class="comments-list">
    <div class="comment">
      ...
      <div class="comments-list">
        <div class="comment">
          <a href="#" class="avatar"><i class="icon-yinyang icon-2x"></i></a>
          <div class="content">
        ...
        <div class="comment">
          <a href="#" class="avatar"><i class="icon-cube-alt icon-2x"></i></a>
          <div class="content">
            <div class="pull-right text-muted">1 个小时前</div>
    ...
    <div class="comment">
      <a href="#" class="avatar"><i class="icon-heart-empty icon-2x"></i></a>
      <div class="content">
